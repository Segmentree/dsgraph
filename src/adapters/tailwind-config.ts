...
const SECTION_CATEGORY: Record<string, TokenCategory> = {
  ...
  letterSpacing: TokenCategory.letterSpacing,
  borderRadius: TokenCategory.radius,
  borderWidth: TokenCategory.borderWidth,
  blur: TokenCategory.blur,
  opacity: TokenCategory.opacity,
  aspectRatio: TokenCategory.aspectRatio,
  transitionDuration: TokenCategory.duration,
  transitionTimingFunction: TokenCategory.easing,
